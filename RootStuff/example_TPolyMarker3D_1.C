//Copied from https://root.cern.ch/root/html512/examples/tornado.C.html
// Didn't work
//Finally, it worked after
//     copying the code from https://root.cern/doc/master/tornado_8C.html
//
//TPolyMarker3D example

//void tornado()
{
  // To see the output of this macro, click //here (https://root.cern.ch/root/html512/examples/gif/tornado.gif)
  //gROOT->Reset();
