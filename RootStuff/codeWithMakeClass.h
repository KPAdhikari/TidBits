...
// Sun Jul 29 22:31:03 2018 by ROOT version 5.34/36
// from TTree h10/All_out
// found on file: root_51570_pass2.a00.root
//////////////////////////////////////////////////////////

#ifndef codeWithMakeClass_h
#define codeWithMakeClass_h
...
public :
   ...
   codeWithMakeClass(TTree *tree=0);
   virtual ~codeWithMakeClass();
...
#ifdef codeWithMakeClass_cxx
codeWithMakeClass::codeWithMakeClass(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root_51570_pass2.a00.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root_51570_pass2.a00.root");
      }
...
codeWithMakeClass::~codeWithMakeClass()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t codeWithMakeClass::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t codeWithMakeClass::LoadTree(Long64_t entry)
{
...
void codeWithMakeClass::Init(TTree *tree)
{
...
Bool_t codeWithMakeClass::Notify()
{
...
void codeWithMakeClass::Show(Long64_t entry)
{
...
Int_t codeWithMakeClass::Cut(Long64_t entry)
{
...
#endif // #ifdef codeWithMakeClass_cxx
