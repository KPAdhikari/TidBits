...
public class FXMLViewPageController implements Initializable {
    ...
    private void refreshList() {
        ...
        //Set the view to what we just populated with DB contents
    ...
    private void getTasks(ObservableList items, String orderby, String ascdesc) {
        ...
        try {
            ...
            System.out.println("Query is: SELECT * FROM Tasks" + "ORDER BY " + orderby 
                        + " COLLATE NOCASE " + ascdesc);
            stmt = c.createStatement();
            ResultSet rs = stmt.executeQuery("Query is: SELECT * FROM Tasks" + "ORDER BY " + orderby 
                        + " COLLATE NOCASE " + ascdesc);
            while ( rs.next()) {
    ...
    private void deleteTask(){
      ...
      stmt = c.createStatement();
      String selected_item = tasks_listview.getSelectionModel().getSelectedItem().toString();
      //Timing is one of the primary keys
