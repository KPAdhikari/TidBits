...
public class FXMLInsertPageController { //implements Initializable {
    ...
    private void doneButtonAction(ActionEvent event) throws IOException {
        System.out.println("Done button in the Home Page is clicked.");
...
//        query = "INSERT INTO Tasks (TITLE,LOCATION,NOTES,TIMING) VALUES (" 
//                + "'" + title_text.getText() + "'," + "'" + location_text.getText()
//                + "'," + "'" + notes_text.getText() + "'," + "'" + date_picker.getValue()
//                + " " + hour_value + ":" + minute_menubutton.getText() + ":00" + "');";
